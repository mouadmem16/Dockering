...
## Hosting a Samba instance
    ...
    sudo docker run -it -p 139:139 -p 445:445 -d mouadmem16/samba -p

OR set local storage:

    sudo docker run -it --name samba -p 139:139 -p 445:445 \
                -v /path/to/directory:/mount \
                -d mouadmem16/samba -p

## Configuration

    sudo docker run -it --rm mouadmem16/samba -h
...
### Setting the Timezone
    ...
    sudo docker run -it -e TZ=EST5EDT -p 139:139 -p 445:445 -d mouadmem16/samba -p
...
This files are forked from this repository (dperson/samba)[https://github.com/dperson/samba]
